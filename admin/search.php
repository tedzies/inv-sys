  ...
  <div class="container">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="./show.php?table=<?php echo $table ?>&sort=no_aset"> <?php echo $table; ?></a></li>
      </ol>
    </nav>
    ...
    <div class="d-flex justify-content-between">
      ...
      <form action="./search.php?table=<?php echo $table ?>" method="post">
        <div class="input-group">
          ...
          <button class="btn btn-outline-primary" type="submit" id="search-button">Cari</button>
        </div>
      </form>
    </div>
    ...
    <tr class="table-danger">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $noaset = strtoupper(input($_POST["cari"]));
        $table = input($_POST["table"]);
      }

      $sql = "select * from $table where no_aset like '%$noaset%'";
          ...
          <div class="modal fade" id="deleteModal<?php echo $data['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Hapus <?php echo $data['no_aset']; ?>?</p>
                </div>
                <div class="modal-footer">
                  <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?table=<?php echo htmlspecialchars($table) ?>&id=<?php echo $data['id']; ?>" class="btn btn-danger in-table" role="button">Hapus</a>
      ...
      <div class="modal fade" id="deleteCatModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Hapus Kategori <?php echo $table; ?>?</p>
            </div>
            <div class="modal-footer">
              <a href="./dashboard.php?table=<?php echo $table; ?>" class="btn btn-danger" role="button">Hapus</a>
              <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Batal</button>
            </div>
          </div>
        </div>
