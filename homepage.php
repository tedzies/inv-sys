  ...
  <div class="row h-100 w-100 align-items-center justify-content-center">
    <div class="card" style="width: 24rem;">
      ...
      <div class="card-body d-flex flex-column align-items-center p-0">
        ...
        <p class="card-text fw-medium">LOGIN AS</p>
        <div class="d-flex flex-column w-100 mb-3">
          <button class="btn btn-primary m-1 cta" type="button" id="log-in-button">User</button>
          <button class="btn btn-primary m-1 cta" type="button" id="log-in-button">Admin</button>
        </div>
